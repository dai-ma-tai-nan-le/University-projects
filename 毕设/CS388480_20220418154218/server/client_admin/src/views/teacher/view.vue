		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','teacher_number') || $check_field('add','teacher_number') || $check_field('set','teacher_number')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="教师编号" prop="teacher_number">
					<el-input id="teacher_number" v-model="form_sub['teacher_number']" placeholder="请输入教师编号"
							  v-if="user_group === '管理员' || (form_sub['teacher_id'] && $check_field('set','teacher_number')) || (!form_sub['teacher_id'] && $check_field('add','teacher_number'))"></el-input>
					<div v-else-if="$check_field('get','teacher_number')">{{form_sub['teacher_number']}}</div>
				</el-form-item>
			</el-col>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','courses_taught') || $check_field('add','courses_taught') || $check_field('set','courses_taught')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="所教课程" prop="courses_taught">
					<el-input id="courses_taught" v-model="form_sub['courses_taught']" placeholder="请输入所教课程"
							  v-if="user_group === '管理员' || (form_sub['teacher_id'] && $check_field('set','courses_taught')) || (!form_sub['teacher_id'] && $check_field('add','courses_taught'))"></el-input>
					<div v-else-if="$check_field('get','courses_taught')">{{form_sub['courses_taught']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','class_name') || $check_field('add','class_name') || $check_field('set','class_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="班级名称" prop="class_name">
					<el-input type="textarea" id="class_name" v-model="form_sub['class_name']" placeholder="请输入班级名称"
						v-if="user_group === '管理员' || (form_sub['teacher_id'] && $check_field('set','class_name')) || (!form_sub['teacher_id'] && $check_field('add','class_name'))"></el-input>
		...
		data() {
			return {
				...
				disabledObj:{
					...
					"courses_taught_isDisabled": false,
