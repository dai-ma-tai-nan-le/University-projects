<template>
    <div id="data">
        <h1>数据统计</h1>
        <el-button type="primary" v-if="username != undefined" style="float: left;margin-top: -50px;margin-left: 1100px;"
        ...
        <div class="zz">
            ...
            <el-col>
                <el-form ref="form" :model="form">
                    ...
                    <el-col class="el_form_item_warp" style="margin-left: -60px;">
                    ...
                    <el-col class="el_form_item_warp" style="margin-left: 20px;">
        ...
        <div class="zz">
            ...
            <el-col>
                <el-form ref="form" :model="form">
                    ...
                    <el-col class="el_form_item_warp">
                        <el-form-item label="时长:" style="margin-left: 285px;width: 300px;">
                            <span>
...
export default {
    ...
    methods: {
        getDay(day) {
            ...
            this.weekStart = this.getDay(-6);
            this.weekEnd = this.getDay(-13);
        }, yuejj() {
