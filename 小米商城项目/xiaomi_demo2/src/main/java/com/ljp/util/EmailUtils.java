...
public class EmailUtils {
	public static void sendEmail(User user){
		//发送方
		String myAccount = "javagp11@163.com";
		//授权码
		String myPass = "GTROJDUZXZQZWTZO";
		//发件人 邮箱的 SMTP 服务器地址
	...
	private static MimeMessage createMsg(Session session, String myAccount, User user) {
		...
		try {
			...
			String url = "http://"+ip+":8080/gp11xiaomi/activate?e="+ Base64Utils.encode(user.getUemail())+"&c="+Base64Utils.encode(user.getCode());
