	...
	<div class="regist">
		<div class="regist_center">
			...
			<div class="center-block" style="margin-top: 80px;">
				<form id="form1" class="form-horizontal" action="userservlet?method=regist" method="post">

					<div class="form-group">
						<label class="col-sm-2 control-label">用户名</label>
						<div class="col-sm-8" style="width: 40%">
							<input type="text" id="username" name="username" value="${username}" class="form-control col-sm-10"
					...
					<div class="form-group">
						...
						<div class="col-sm-8" style="width: 40%">
							<input type="password" name="repassword" value="${repassword}" class="form-control col-sm-10"
					...
					<div class="form-group">
						...
						<div class="col-sm-8" style="width: 40%">
							<input type="email" name="email" value="${email}" class="form-control col-sm-10"
								placeholder="Email" />
						</div>
						<div class="col-sm-2">
					...
					<div class="form-group">
						...
						<div class="col-sm-8" style="width: 40%">
							<label class="radio-inline"> <input type="radio"
								...
								name="gender" value="女" ${gender=='女'?"checked":""}> 女
							</label>
						</div>
						<div class="col-sm-2">
