	...
	$(document).ready(function(){
		$.ajax({
			...
			success:function(data){
				for(var i in data){
					var a = $("<a href='${pageContext.request.contextPath}/goodsservlet?method=getGoodsListByTypeId&typeId="+data[i].tid+"'>"+data[i].tname+"</a>");
					$("#goodsType").append(a);
    	...
    	<div id="topdiv">
            ...
            <span style="float:right">
       			...
       			<c:if test="${not empty user}">
       				<a href="userAddress?flag=show" id="a_top">${user.uname}</a>
       				<li>|</li>
       				<a href="userservlet?method=logOut" onclick="return confirm('确定要退出吗？')" id="a_top">注销</a>
       				<li>|</li>
       				<a href="orderservlet?method=getOrderView" id="a_top">我的订单</a>
       				<li>|</li>
...
<div id="second">
       ...
       <form action="${pageContext.request.contextPath}/goodsservlet?method=getGoodsListByTypeId" method="post" class="form-inline pull-right" style="margin-top: 40px;margin-right: 10px;">
		
		  <div class="form-group">
		    <input type="text" name="name" value="${name}" class="form-control" style="width: 400px"  placeholder="搜索一下好东西...">
		  </div>
